(function() {
...
})()(
  {
      ...
      function(require, module, exports) {
        ...
        function createComponent(tag, dataAccessor) {
          return shared_1.tryAndCatchOrReturn(function() {
            ...
            const component = Object.assign(Object.assign({}, node), {
              useAsWebComponent() {
    ...
    16: [
      ...
      { './_dom': 10, './_error': 11, './_event': 12, './_logger': 13, './_regex': 14, './_utils': 15 }
    ],
    17: [
      function(require, module, exports) {
        'use strict';
      ...
      { './component': 2, './injectable': 9, './snake': 32 }
    ],
    18: [
      function(require, module, exports) {
        'use strict';
      ...
      function(require, module, exports) {
        ...
        function translateInjectables(node, injectablesIds) {
          return injectablesIds.map(function(injectableId) {
            ...
            if (!injectable) {
              kernel_1.throwNewError(
                `"${injectableId}" is not declared as injectable in the "${node.__property('tag')}" node.`
              );
            }
    ...
    22: [
      ...
      { './_data-accessor': 19, './_injectables': 20, './_template-injection': 21, './rendering': 27 }
    ],
    23: [
      function(require, module, exports) {
        'use strict';
        ...
        function injectContentsToBindedDomElements(node) {
          Object.keys(node.__property('bindedDomElements')).forEach(function(uid) {
            node.__injectContentToBindedDomElement(
              kernel_1.runCodeBindingObject(node.__property('scriptedData')[uid], node.__data()),
              uid
            );
          });
        }
    ...
    24: [
        ...
        function loadNodeView(node, nodeDomElement) {
            ...
            node.__property('components').forEach(function(component) {
              nodeDomElement
                ...
                .forEach(function(element) {
                  ...
                  nodeDomElement.replaceChild(
                    window.document.createElement(`s-${component.__property('tag')}`),
                    element
                  );
                });
            });
          ...
          node.__property('components').forEach(function(component) {
            nodeDomElement.querySelectorAll(`s-${component.__property('tag')}`).forEach(function(element) {
              element.outerHTML = `<div ${kernel_1.snakeComponentCommonAttribute()}="${component.__property(
                'tag'
      ...
      { '../../../../kernel': 16, './_dom-elements': 23, './_outputs': 25, './_render-node': 26 }
    ],
    25: [
      function(require, module, exports) {
        'use strict';
              ...
              element.addEventListener(eventType, function(event) {
                if (attributeValue.match(/(\(.*\))/gm)) {
                  ...
                  if (node.__data().hasOwnProperty(propertyName) && typeof node.__data()[propertyName] === 'function') {
                    ...
                    propertyParams.forEach(function(property) {
                      if (property === '$event') {
                        ...
                        if (node.__data().hasOwnProperty(property)) {
                          ...
                          kernel_1.throwNewError(
                            `"${property}" is not a property of component "${node.__property('tag')}".`
                          );
                        }
                      }
                    });
                    ...
                    kernel_1.throwNewError(
                      `"${propertyName}" method is not callable on component "${node.__property('tag')}".`
                    );
                  }
                } else {
    ...
    26: [
      function(require, module, exports) {
        ...
        function renderNode(_node) {
          ...
          if (!nodeDomElement) {
            nodeDomElement = window.document.querySelector(
              `[${kernel_1.snakeComponentCommonAttribute()}=${node.__property('tag')}]`
            );
          }
          if (!nodeDomElement) {
      ...
      { '../../../../kernel': 16, './_dom-elements': 23, './_load-node-view': 24 }
    ],
    27: [
      function(require, module, exports) {
        'use strict';
      ...
      { './_dom-elements': 23, './_load-node-view': 24, './_outputs': 25, './_render-node': 26 }
    ],
    28: [
      function(require, module, exports) {
        'use strict';
    ...
    29: [
      function(require, module, exports) {
        ...
        function createNode(_properties, _dataAccessor) {
          const properties = Object.assign(Object.assign({}, _properties), {
            bindedDomElements: {},
          ...
          const node = {
            ...
            registerInjectable(injectable) {
              ...
              properties.injectableDictionnay = Object.assign(
                Object.assign({}, properties.injectableDictionnay),
                patch
              );
              helpers_1.transferInjectablesToChildComponents(this);
              return this;
      ...
      { '../../../kernel': 16, '../../../shared': 31, '../helpers': 22 }
    ],
    30: [
      function(require, module, exports) {
        'use strict';
      ...
      function(require, module, exports) {
        ...
        function snake(_selector, _data) {
          ...
          <p>You just created a Snake.js app here.</h1>`
              ...
              {
                enableTemplateInjection(value = true) {
